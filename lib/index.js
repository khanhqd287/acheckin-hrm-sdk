...
var ACheckinSDK = (function () {
    ...
    ACheckinSDK.takePhotoUrl = function () {
        ACheckinSDK.validInitSDK();
    ...
    ACheckinSDK.getUserPersonalInfo = function () {
        ACheckinSDK.validInitSDK();
        return window.ACheckin.handleSDK("getUserPersonalInfo");
    };
    ACheckinSDK.getUserWorkspaceInfo = function () {
        ACheckinSDK.validInitSDK();
    ...
    ACheckinSDK.getStaffOfLeader = function (fields) {
        ACheckinSDK.validInitSDK();
